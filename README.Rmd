...
From these two boxplots above, we can see that the range of type 3 is much smaller than type 2 and also the number of active status is bigger no matter it is a success or failure.
